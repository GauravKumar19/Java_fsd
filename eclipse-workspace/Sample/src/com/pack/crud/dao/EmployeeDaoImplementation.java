...
import com.pack.crud.util.databaseconnection;
...
public class EmployeeDaoImplementation implements EmployeeDao {
  ...
  public Employee createtable() throws SQLException{
	 ...
	 String query ="create table if NOT EXISTS Employee (empid int auto_increment,empname varchar(50),empaddress varchar(400),primary key(empid))";
